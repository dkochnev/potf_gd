...
$(function() {
	...
	function scrollRelation() {
		var fromTop = $(this).scrollTop(),
			...
			curr = scrollItems.map(function() {
				if ($(this).offset().top -($(this).attr('id') == 'contacts'?200:0) <= fromTop + headerHeight + ((windowHeight >= 480 && windowWidth >= 480 && windowWidth < 1440 && $(this).attr('id') != 'intro' && $(this).attr('id') != 'ppage' && $(this).attr('id') != 'knowledge') ? 50 : 0))
					return this;
			});
	...
	$('header.header .nav a, footer.footer a, .nav-ctrl a, header.header .top').click(function(e) {
		...
		var offsetTop = (href === '#') ? 0 : $(href).offset().top - headerHeight - ((windowHeight >= 480 && windowWidth >= 480 && windowWidth < 1440 && href != '#intro' && href != '#ppage' && href != '#knowledge' && href != '#about' && href != '#contacts') ? 49 : 0);

		if (href == '#intro' || href == '#ppage' || href == '#about' || href == '#') {
